...
// se_mat3
extern se_mat3 mat3_mul(const se_mat3 A, const se_mat3 B);
extern se_mat3 mat3_translate(const se_vec3 *v);
extern se_mat3 mat3_rotate(se_mat3 m, f32 angle);
extern se_mat3 mat3_scale(const se_vec3 *v);
