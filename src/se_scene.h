...
// 2D scene functions
extern se_scene_2d* se_scene_2d_create(se_scene_handle* scene_handle, const se_vec2* size);
...
// 3D scene functions
extern se_scene_3d* se_scene_3d_create(se_scene_handle* scene_handle, const se_vec2* size);
