...
#define SE_PHYSICS_WORLD_2D_HANDLE_NULL S_HANDLE_NULL
#define SE_PHYSICS_WORLD_3D_HANDLE_NULL S_HANDLE_NULL
#define SE_PHYSICS_BODY_2D_HANDLE_NULL S_HANDLE_NULL
#define SE_PHYSICS_BODY_3D_HANDLE_NULL S_HANDLE_NULL
#define SE_PHYSICS_SHAPE_2D_HANDLE_NULL S_HANDLE_NULL
#define SE_PHYSICS_SHAPE_3D_HANDLE_NULL S_HANDLE_NULL
...
typedef struct {
	se_physics_body_2d_handle a;
	se_physics_body_2d_handle b;
	se_physics_shape_2d_handle shape_a;
	se_physics_shape_2d_handle shape_b;
	s_vec2 normal;
	f32 penetration;
...
typedef struct {
	se_physics_body_3d_handle a;
	se_physics_body_3d_handle b;
	se_physics_shape_3d_handle shape_a;
	se_physics_shape_3d_handle shape_b;
	s_vec3 normal;
	f32 penetration;
...
typedef struct {
	...
	se_physics_shape_2d_handle shape;
	s_vec2 point;
	s_vec2 normal;
	f32 distance;
...
typedef struct {
	...
	se_physics_shape_3d_handle shape;
	s_vec3 point;
	s_vec3 normal;
	f32 distance;
